    ...
    >
      ...
      <div className="flex justify-center items-center w-full h-full">
        <img
          src={product.image}
          alt={product.name}
          // className="w-84 h-80 xs:w-48 xs:h-32 sm:w-64 sm:h-40 py-2 object-cover hover:scale-110 transition"
          className="xs:w-48 xs:h-32 sm:w-64 sm:h-40 lg:w-84 lg:h-50 xl:w-96 xl:h-60 py-2 object-cover hover:scale-110 transition"
        />
      </div>
    </Link>
  );
